...
<div class="article-content homepage-redesign">
  ...
  <section class="library-search" aria-labelledby="hp-library-search-heading" style="margin: 0.2rem 0 1.2rem 0; text-align: left;">
    <h2 id="hp-library-search-heading" style="margin: 0 0 0.4rem 0; font-size: 1.25rem; color: #3a2a13;">Search the Library</h2>
    <p data-library-search-status style="margin: 0.35rem 0 0.6rem 0; color: #6a5738;">Search by scripture, tags, themes, or article text.</p>
    <label class="library-search-label" for="hp-library-search-input" style="display: block; margin-bottom: 0.3rem; font-size: 0.92rem; color: #5d4a2a;">Search</label>
    <input
  ...
  <style>
    ...
    .library-search-item h3 {
      margin: 0;
      font-size: 1.05rem;
    }

    .library-search-item h3 a {
      color: #6b4f2c;
    }
