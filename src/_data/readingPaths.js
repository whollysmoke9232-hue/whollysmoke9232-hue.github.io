...
{ url: '/reflections/roadblocks/', title: 'Roadblocks' },
{ url: '/reflections/want-tos/', title: 'Want To’s' },
{ url: '/reflections/seek-first/', title: 'Seek First' },
{ url: '/testimonies/when-the-order-matters/', title: 'When the Order Matters' }
],
...
{ url: '/reflections/unpacking-holiness/', title: 'Unpacking Holiness' },
{ url: '/reflections/loving-judge/', title: 'Loving Judge' },
{ url: '/reflections/all-things/', title: 'All Things' },
{ url: '/reflections/the-lord-is-my-shepherd/', title: 'The LORD Is My Shepherd' },
{ url: '/reflections/the-big-picture/', title: 'The Big Picture' }
],

'knowing-god-following-him': [
{ url: '/reflections/seek-first/', title: 'Seek First' },
{ url: '/meditations/stand-where-jesus-stood/', title: 'Stand Where Jesus Stood' },
{ url: '/reflections/want-tos/', title: 'Want To’s' },
{ url: '/reflections/working-from-grace/', title: 'Working From Grace' },
{ url: '/reflections/faith-from-beginning-to-end/', title: 'Faith, From Beginning to End' },
{ url: '/reflections/from-it-or-through-it/', title: 'From It or Through It' }
...
{ url: '/reflections/worship-the-lord/', title: 'Worship the LORD' },
{ url: '/reflections/psalm-119/', title: 'Psalm 119' },
{ url: '/reflections/open-my-eyes/', title: 'Open My Eyes' },
{ url: '/reflections/not-subdued/', title: 'Not Subdued' }
],
