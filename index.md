...
<div class="article-content homepage-redesign">
  ...
  <section class="library-search" aria-labelledby="hp-search-heading" style="margin: 0.5rem 0 1.2rem 0;">
    <h2 id="hp-search-heading">Search the Library</h2>
    <p data-library-search-status>Search by scripture, tags, themes, or article text.</p>
    <label class="library-search-label" for="hp-library-search-input">Search</label>
    <input
      id="hp-library-search-input"
      data-library-search-input
      type="search"
      placeholder="Try: Psalm 119, surrender, holiness, or any phrase"
      autocomplete="off"
      disabled
    />
    <p class="library-search-count" data-library-search-count></p>
    <div class="library-search-results" data-library-search-results aria-live="polite"></div>
  </section>
...
<style>
.library-search{width:min(1040px,95vw);margin:0 auto 2rem auto;padding:1.1rem 1.2rem;border:1px solid #e0d6c3;border-radius:8px;background:#fffdf5;}
.library-search h2{margin:0 0 0.4rem 0;font-size:1.25rem;color:#3a2a13;}
.library-search p{margin:0.35rem 0 0.6rem 0;color:#6a5738;}
.library-search-label{display:block;margin-bottom:0.3rem;font-size:0.92rem;color:#5d4a2a;}
.library-search input{width:100%;box-sizing:border-box;border:1px solid #ccb993;border-radius:6px;padding:0.65rem 0.75rem;font-size:1rem;}
.library-search input:focus{outline:2px solid #c29f67;outline-offset:1px;}
.library-search-count{font-weight:600;color:#4d3a1b;}
.library-search-results{display:grid;gap:0.85rem;}
.library-search-item{border:1px solid #eadfc8;border-radius:6px;background:#fffef9;padding:0.7rem 0.8rem;}
.library-search-item h3{margin:0;font-size:1.05rem;}
.library-search-item h3 a{color:#6b4f2c;}
.library-search-preview{margin:0.45rem 0;color:#4f412c;}
.library-search-meta{margin:0;font-size:0.88rem;color:#7a6645;}
.library-search-empty{margin:0;color:#6a5738;}
</style>
