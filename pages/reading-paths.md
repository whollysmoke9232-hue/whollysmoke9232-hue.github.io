...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: center; margin-top: 2rem;">
  ...
  <div>
    ...
    <p>
      When the ground shifts and you cannot see what God is doing, these reflections steady your footing and widen your view.
    </p>
  </div>
...
<div style="text-align: center; margin-bottom: 0.6rem;">
  <a href="/youre-not-alone/" style="text-decoration: none; color: inherit;">
    If addiction, pornography, or sexual compulsion has been part of your story, there's a place for you too.
  </a>
</div>

<div style="text-align: center; margin-top: 0.75rem;">
  <a href="/youre-not-alone/">
    <img src="{{ '/images/youre-not-alone.png' | url }}" alt="You're Not Alone" style="max-width: 100%; border-radius: 8px;">
  </a>
</div>
